...
char Player1(int round, char prevAns, char outcome) { // If you win then you choose what the opponent just played, If you lost then you choose what neither of you played, 
...
char Player2(char prev1, char prev2) { 
    if (prev1 == prev2) 
    {
        if (prev2 == 'R')
        {
...
int main()
{
    ...
    for (int i = 1; i <= rounds; i++) {
        ...
        player2 = Player2(prevAnswer2, prevAnswer3);
        player1 = Player1(i, prevAnswer1, outcome);
